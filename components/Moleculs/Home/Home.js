...
const Project = () => {
  let listProject = [
    ...
    {
      title: "Food Market App - BackEnd ",
      desc: "Food Market app is application to make an order on mobiile app using Kotlin, with BackEnd using Laravel, but, it's on progress right now..",
